...
namespace CannedBytes.Midi.Device.Converters
{
    ...
    {
        private readonly Dictionary<string, DataConverter> _dataConverters = 
            new Dictionary<string, DataConverter>();
        ...
        public DataConverter LookupConverter(DataType dataType)
        {
            ...
            if (_dataConverters.TryGetValue(dataType.Name.FullName, out converter))
            {
                return converter;
            }
