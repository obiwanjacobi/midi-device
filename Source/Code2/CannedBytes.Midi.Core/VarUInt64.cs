...
namespace CannedBytes.Midi.Core
{
    ...
    public struct VarUInt64
    {
        ...
        {
            _value = value;
            _typeCode = TypeCodeFor(_value);
            _typeCodeIsFixed = false;
        }
        ...
        public VarUInt64(ulong value, VarTypeCode typeCode)
        {
            _value = value;
            _typeCode = typeCode;
            _typeCodeIsFixed = true;
        }

        private bool _typeCodeIsFixed;
        ...
        private VarTypeCode _typeCode;

        /// <summary>
        /// Gets the actual size of this instance.
        /// </summary>
        public VarTypeCode TypeCode
        {
        ...
        /// <summary>
        /// Retruns a native .NET type for a specific size.
        /// </summary>
        ...
        private void ThrowIfInvalidCast(VarTypeCode typeCode)
        {
            if (_typeCode > typeCode)
            {
                throw new InvalidCastException(
                    String.Format(
                        "The value '{0}' can not be cast to type code '{1}'. It is too big '{2}'.", 
                        _value, typeCode, TypeCode));
            }
        }
